...
from habits.validators import ChoiceValidator, TimeValidator, PleasantRelatedValidator, PleasantValidator, \
...
class HabitSerializer(ModelSerializer):
    class Meta:
        ...
        validators = [
            ...
            PleasantRelatedValidator(field1='related_habit', field2='is_pleasant_habit'),
